...
// // import { workflow } from "../agent/inmo.js";
// // import { SYSTEM_PROMPT_TEMPLATE } from "../agent/constants.js";
...
//             console.log("props", state.values.ui.at(-1));
           
            
//             clientInfo.ws.send(
//                 JSON.stringify({
//                     type: "ui",
//                     data: state.values.ui.at(-1)
//                 }))
//         }
